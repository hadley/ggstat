...
condense_count <- function(x, min, max, width, pad, right_closed, w) {
    .Call('ggstat_condense_count', PACKAGE = 'ggstat', x, min, max, width, pad, right_closed, w)
}

condense_sum <- function(x, min, max, width, pad, right_closed, z, w) {
    .Call('ggstat_condense_sum', PACKAGE = 'ggstat', x, min, max, width, pad, right_closed, z, w)
}

condense_moments <- function(x, min, max, width, pad, right_closed, z, w) {
    .Call('ggstat_condense_moments', PACKAGE = 'ggstat', x, min, max, width, pad, right_closed, z, w)
}

condense_median <- function(x, min, max, width, pad, right_closed, z, w) {
    .Call('ggstat_condense_median', PACKAGE = 'ggstat', x, min, max, width, pad, right_closed, z, w)
}
...
group_fixed <- function(x, width, min, max, pad = FALSE, right_closed = FALSE) {
    .Call('ggstat_group_fixed', PACKAGE = 'ggstat', x, width, min, max, pad, right_closed)
}
